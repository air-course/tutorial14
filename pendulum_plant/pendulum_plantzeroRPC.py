...
class PendulumPlant:
    ...
    def run_on_hardware_hash(self, tf, dt, controller=None, starting_pos=0):
        ...
        exp_hash, self.live_url = self.c.start_experiment("hello", "SimplePendulum", tf + 10.0)
    ...
    def run_on_hardware_hash_parallel(self, tf, dt, controllers=None, starting_pos=0, number_experiments=3):
            ...
            for i in range(number_experiments):
                exp_hashes[i], self.live_url = self.c.start_experiment("hello", "SimplePendulum", tf + 10.0)
            #print("Your experiment hash key is:", exp_hash)
            exp_hashes_stopped = []
