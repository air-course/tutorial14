...
# Local imports
from sac.abstract_controller import AbstractController
...
class SacController(AbstractController):
    ...
    def get_control_output(self, meas_pos, meas_vel, meas_tau=0, meas_time=0):
        ...
        if self.use_symmetry:
            ...
            des_tau, _states = self.model.predict(observation, deterministic=self.deterministic)
